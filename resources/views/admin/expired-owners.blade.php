          ...
          <section class="text-gray-600 body-font">
            <div class="container px-5 mx-auto">
              <div class="flex flex-col text-center w-full mb-4">
                <h1 class="sm:text-4xl text-3xl font-medium title-font mb-2 text-gray-900">期限切れオーナー 一覧(ソフトデリート)</h1>
              </div>
                        ...
                        <form id="delete_{{ $owner->id }}" action="{{ route('admin.expired-owners.destroy', ['owner' => $owner->id]) }}" method="post">
                          ...
                          <td class="w-35 text-center ">
                            <a href="#" onclick="deletePost(this)" data-id="{{ $owner ->id }}"
                              class=" bg-red-200 border-0 py-2 px-6 focus:outline-none hover:bg-red-400">完全に削除</a>
                          </td>
                        </form>
                      </tr>
                    @endforeach
